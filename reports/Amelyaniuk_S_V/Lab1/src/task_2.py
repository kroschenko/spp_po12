"""Модуль для нахождения общего префикса строк."""


def longest_common_prefix(strs):
    """Находит самую длинную общую строку префикса для списка строк."""
    if not strs:
        return ""
...
def main():
    """Основная функция для ввода строк и вывода результата."""
    print("=== Задание 2 ===")
