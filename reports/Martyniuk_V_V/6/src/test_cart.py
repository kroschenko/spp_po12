...
def test_log_purchase_with_correct_data(mock_post):
    ...
    log_purchase(item)
    mock_post.assert_called_once_with("https://example.com/log", json=item, timeout=30)
...
def test_log_purchase_multiple_calls(mock_post):
    ...
    for single_item in items:
        mock_post.assert_any_call("https://example.com/log", json=single_item, timeout=30)
