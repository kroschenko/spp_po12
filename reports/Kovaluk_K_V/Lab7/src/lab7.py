...
class RotatingSegment:
    ...
    def update(self):
        ...
        center_x = (self.point_a[0] + self.point_b[0]) / 2
        center_y = (self.point_a[1] + self.point_b[1]) / 2
...
class KochSnowflake:
    ...
    def get_snowflake_points(self, iteration):
        ...
        point3 = (center_x + radius * math.cos(angle3), center_y + radius * math.sin(angle3))
    ...
    def update(self):
        ...
        target_iteration = int(self.current_iteration + self.animation_progress)
        if target_iteration > self.iterations:
