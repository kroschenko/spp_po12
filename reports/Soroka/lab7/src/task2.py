# pylint: disable=invalid-name, too-many-instance-attributes, broad-exception-caught, too-many-locals, too-few-public-methods
"""
...
class Task2App:
    ...
    def __init__(self, root: tk.Tk):
        ...
        tk.Button(
            control_frame, text="Построить", command=self.draw_fractal
    ...
    def draw_fractal(self):
        ...
        try:
            ...
            if depth < 0 or depth > 5:
                messagebox.showwarning("Внимание", "Глубина от 0 до 5, иначе будет зависание!")
                return
            ...
            padding = 40
            scale = min((self.width - padding) / fractal_w,
                        (self.height - padding) / fractal_h)
    ...
    def take_screenshot(self):
        ...
        try:
            img = ImageGrab.grab(bbox=(root_x, root_y, root_x + canvas_w, root_y + canvas_h))
